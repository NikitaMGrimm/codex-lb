...
def _refresh_websocket_request_input_fingerprint_from_text(*args: Any, **kwargs: Any) -> Any:
    return _service_global("_refresh_websocket_request_input_fingerprint_from_text")(*args, **kwargs)
