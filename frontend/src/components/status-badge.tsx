...
type StatusValue = "active" | "paused" | "limited" | "limitReached" | "exceeded" | "reauth" | "deactivated";
...
const statusClassMap: Record<StatusValue, string> = {
  ...
  limitReached: "bg-orange-500/15 text-orange-700 border-orange-500/20 hover:bg-orange-500/20 dark:text-orange-400",
